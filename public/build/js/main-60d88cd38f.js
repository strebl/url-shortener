...
},{"select":21}],14:[function(require,module,exports){
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
...
},{"./clipboard-action":13,"good-listener":18,"tiny-emitter":23}],15:[function(require,module,exports){
...
},{"matches-selector":20}],16:[function(require,module,exports){
...
var _class = function () {
    function _class() {
        ...
        var clipboard = new _clipboard2.default('[data-toggle="tooltip"]');

        clipboard.on('success', function (e) {
            _this.showTooltip(e.trigger, 'Copied!');
        });

        clipboard.on('error', function (e) {
            _this.showTooltip(e.trigger, 'Press ⌘+C to copy');
        });
    }

    _createClass(_class, [{
        key: 'showTooltip',
        value: function showTooltip(element, text) {
            $(element).attr('title', text).tooltip('dispose').tooltip('show');
        }
    }]);
...
},{"bootstrap":1,"clipboard":14,"jquery":19,"tether":22}],25:[function(require,module,exports){
(function (global){
'use strict';
...
},{"bootstrap":1,"jquery":19,"tether":22}],26:[function(require,module,exports){
'use strict';
...
new _tooltips2.default();
new _clipboard2.default();

},{"./components/clipboard":24,"./components/tooltips":25}]},{},[26]);
